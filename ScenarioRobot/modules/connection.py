...
import ScenarioRobot.modules.sql.connection_sql as sql
from ScenarioRobot import dispatcher, DRAGONS, DEV_USERS
from ScenarioRobot.modules.helper_funcs import chat_status
