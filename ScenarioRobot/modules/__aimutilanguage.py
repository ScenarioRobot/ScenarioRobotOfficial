# Support Every Langauge Don't change anything not gonna work
from ScenarioRobot import OWNER_ID, BOT_ID
from ScenarioRobot import telethn as tbot
import ScenarioRobot.modules.sql.aihelp_sql as sql
import ScenarioRobot.modules.sql.chatbot_sql as ly
...
string = (
  "I belong To Mr Akku @userderdead !",
  "Im totally runs under scenario robot. Thanks to akku for that!",
)
...
async def _(event):
    ...
    if not is_chat:
        ...
        return
    await event.reply("AI Scenario is already enabled for this chat!")
    return ""
...
async def _(event):
    ...
    await event.reply("AI Scenario disabled successfully!")
