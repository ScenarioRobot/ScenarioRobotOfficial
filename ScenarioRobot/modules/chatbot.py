...
import html
import requests
import ScenarioRobot.modules.sql.chatbot_sqll as sql
...
from ScenarioRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from ScenarioRobot import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ScenarioRobot Chatbot Disabled By {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Scenario Chatbot Enabled By {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Scenario Enabled Chats</b>\n"
    for chat in chats:
        try:
