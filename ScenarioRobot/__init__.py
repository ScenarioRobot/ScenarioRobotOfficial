...
if ENV:
    ...
    BOT_ID = int(os.environ.get("BOT_ID", 1734870043))
    ...
    from ScenarioRobot.config import Development as Config
    ...
    ARQ_API_KEY = os.environ.get("ARQ_API_KEY", "NWXVEV-JVFTPY-UGTAWP-HELUDM-ARQ")
...
from ScenarioRobot.modules.helper_funcs.handlers import (
