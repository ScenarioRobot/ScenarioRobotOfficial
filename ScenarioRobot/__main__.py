...
DONATE_STRING = """Heya, glad to hear you want to donate!
 ...
 Those who cannot support are welcome to help us develop the bot at @TeamScenario."""
...
@run_async
def Scenario_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "scenario_":
        query.message.edit_text(
            text="""I'm *ScenarioRobot*, a powerful group management bot built to help you manage your group easily.

• Scenario can restrict users.
• Scenario can greet users with customizable welcome messages and even set a group's rules.
• Scenario have an advanced anti-flood system.
• Scenario can warn users until they reach max warns, with each predefined actions such as ban, mute, kick, etc.
• Scenario have a note keeping system, blacklists, and even predetermined replies on certain keywords.
• Scenario check for admins' permissions before executing any command and more stuffs
